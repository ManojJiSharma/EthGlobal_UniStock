        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="mb-20">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed fade-in-delay-2">
              The most advanced decentralized exchange on Sepolia. 
              Swap tokens, provide liquidity, and earn fees with ultra-low gas costs.
            </p>
          ...
          <div className="mb-20">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                The talented developers behind uniStock, building the future of DeFi on Sepolia
              </p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
              {teamMembers.map((member, index) => (
                <Card key={member.name} className="p-6 text-center animated-card hover-lift" style={{ animationDelay: `${index * 0.1}s` }}>
                  <div className="mb-4">
                    <img 
                      src={member.image} 
                      alt={member.name}
          ...
          <div className="text-center">
            <Card className="p-8 animated-card hover-lift glow-effect">
              ...
              <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                Join thousands of users already trading on uniStock. Experience the future of decentralized finance.
              </p>
